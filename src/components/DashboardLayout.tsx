      ...
      >
              ...
              <div className="space-y-0.5">
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <item.icon className={cn("h-4 w-4 shrink-0", active ? "text-violet-500" : "text-muted-foreground")} />
                      <span className="flex-1 truncate">{item.label}</span>
                      {(item as any).badge && unreadCount > 0 && (
                        <span className="ml-auto shrink-0 h-5 min-w-5 px-1.5 rounded-full bg-violet-500 text-white text-[10px] font-bold flex items-center justify-center">
                          {unreadCount}
                        </span>
                      )}
                    </Link>
        ...
        <div className="shrink-0 border-t border-border/40 p-3 space-y-2">
          ...
          <div className="flex items-center gap-2.5 px-3 py-2">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-violet-500 to-indigo-500 flex items-center justify-center text-white text-xs font-bold shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            {profile?.username && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden sm:flex items-center gap-1.5 h-8 px-3 rounded-lg text-xs font-semibold text-violet-600 dark:text-violet-400 bg-violet-500/10 hover:bg-violet-500/15 transition-colors border border-violet-500/20"
              >
