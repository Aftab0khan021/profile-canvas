...
export default function ResetPassword() {
    ...
    useEffect(() => {
        // H-1: Only allow access when Supabase fires PASSWORD_RECOVERY — not for any active session.
        // A logged-in user navigating here directly gets bounced to /forgot-password.
